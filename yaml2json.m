...
if isempty(docstarts)
    ...
    jsonstr = strjoin(documents, sprintf('\n'));
end
...
[jsonstr, ~] = build_structure(items, 1, -1);
...
%% -------------------------------------------------------------------------
function [jsonstr, nextidx] = build_structure(items, startidx, minindent)
